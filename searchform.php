<div id="search-form" class="my-4">
  <form class="relative" method="get" action="<?php echo esc_url(home_url('/')); ?>">
    ...
    <input type="text" class="dark:bg-dark dark:text-gray-400 px-2 py-3 text-lg font-semibold pr-2 w-full outline-none ring-2 focus:ring-primary active:ring-primary" placeholder="搜索..." autocomplete="off" value="<?php echo esc_attr(get_search_query()) ?>" name="s" required="required">
